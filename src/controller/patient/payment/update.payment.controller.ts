...
//@access private
export const updatePatientPayemntHandler = asyncHandler(async (req: Request<z.TypeOf<typeof createOrUpdatePatientAllergySchema>["params"], {}, createOrUpdatePatientAllergyInput>, res: Response) => {
